...
unsigned int Match::getPhysicalTotal(){return matchPhsysicalTotal;}
...
void Match::setPhysicalTotalAndAverage(unsigned int physicalTotal){
    matchPhsysicalTotal = physicalTotal;
    matchPhysicalAverage = matchPhsysicalTotal / 3;
}
void Match::setPhysicalAverage(unsigned int physicalAverage){}

void Match::setMatchTotalAndAverage(){
    matchTotal = matchNonPhysicalTotal + matchPhsysicalTotal;
    matchAverage = matchTotal / 15;
}
